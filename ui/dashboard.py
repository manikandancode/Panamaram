...
class DashboardWidget(QWidget):
    ...
    def __init__(self):
        ...
        # Create all tabs with internal period controls
        (
            self.trend_tab,
            trend_layout,
            self.label_trend,
